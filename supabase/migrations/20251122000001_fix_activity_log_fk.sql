-- Fix foreign key issue: Change user_id to reference profiles instead of auth.users
-- This allows PostgREST to resolve the embedded join for user data
...
CREATE INDEX idx_gig_activity_log_user_id ON gig_activity_log(user_id);
