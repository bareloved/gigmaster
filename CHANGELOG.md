...
- WhatsApp share button for gig contacts
- Mobile-first redesign of public gigpack layout
- One calendar event per gig (replaces per-attendee events)
...
- Simplified gig contacts and redesigned calendar import flow
