...
/**
 * SheetOverlay and SheetContent use z-50 so they layer above the
 * sticky navbar (also z-50, but sheets are portaled later in the DOM).
 * Nested portaled components (Select, Dropdown, Popover) use z-[60]
 * to appear above the sheet.
 */
