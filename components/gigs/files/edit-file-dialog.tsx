...
import { updateGigFile } from "@/lib/api/gig-files";
...
interface EditGigFileDialogProps {
  open: boolean;
...
export function EditGigFileDialog({
  open,
  onOpenChange,
  onSuccess,
  file,
}: EditGigFileDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>Edit File Link</DialogTitle>
            <DialogDescription>
              Update the file link details.
            </DialogDescription>
          </DialogHeader>
